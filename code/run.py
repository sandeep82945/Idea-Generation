...
def generate_gpt(paper_text):
     prompt = f"""Read the following paper and generate all good possible future research ideas after brainstroming:  
        ``` {paper_text}```
        All good possible future research ideas from the paper are: """
